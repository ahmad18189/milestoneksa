...
class PaymentApprovalRequest(Document):
	def validate(self):
		...
		"""
		# Keep this method so we have a safe place for future validations
		pass
	...
	def on_update_after_submit(self):
		"""Triggered on document update after submission"""
		if self.has_value_changed("workflow_state"):
			self.handle_workflow_state_change()
	
	def handle_workflow_state_change(self):
		"""Handle workflow state changes by creating desk announcements"""
